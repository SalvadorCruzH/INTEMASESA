...
<@emasesa.favoritosInitScript custonNameSpace "p_p_id_com_liferay_portal_search_web_search_results_portlet_SearchResultsPortlet_INSTANCE_oznp_"/>
					...
					<div class="autofit-col autofit-col-expand">
						<section class="autofit-section">
							<div class="c-mt-0 list-group-title">
								...
								<@emasesa.favoritos themeDisplay.getUserId() themeDisplay.getScopeGroupId() entry.getClassPK() classNameId custonNameSpace title "URL" extension ""/>
							</div>
