...
public class CambioDomicilioFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(CambioDomicilioFormImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/cambiodomicilio/form.jsp";
