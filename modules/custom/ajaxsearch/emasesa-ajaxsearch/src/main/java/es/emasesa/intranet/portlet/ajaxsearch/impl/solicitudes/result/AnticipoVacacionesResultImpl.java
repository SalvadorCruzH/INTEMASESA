...
public class AnticipoVacacionesResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(AnticipoVacacionesResultImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/anticipovacaciones/results.jsp";
