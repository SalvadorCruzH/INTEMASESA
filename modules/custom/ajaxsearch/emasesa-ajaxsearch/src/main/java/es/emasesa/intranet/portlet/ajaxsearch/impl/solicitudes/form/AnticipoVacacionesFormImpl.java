...
public class AnticipoVacacionesFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(AnticipoVacacionesFormImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/anticipovacaciones/form.jsp";
