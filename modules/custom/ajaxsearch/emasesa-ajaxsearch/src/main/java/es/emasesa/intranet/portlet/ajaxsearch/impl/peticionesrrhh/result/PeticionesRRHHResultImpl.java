package es.emasesa.intranet.portlet.ajaxsearch.impl.peticionesrrhh.result;
...
public class PeticionesRRHHResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(PeticionesRRHHResultImpl.class);
    ...
    private static final String VIEW = "/views/peticionesrrhh/results.jsp";
    ...
    private long performSearchAndParse(final PortletRequest request,
        ...
        List<Document> documents = searchingObject.searchObjects(solicitudesId.split(StringPool.COMMA), searchContext);
