package es.emasesa.intranet.portlet.ajaxsearch.impl.peticionesrrhh.form;
...
public class PeticionesRRHHFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(PeticionesRRHHFormImpl.class);
    ...
    private static final String VIEW = "/views/peticionesrrhh/form.jsp";
