...
public class RestoResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(RestoResultImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/resto/results.jsp";
