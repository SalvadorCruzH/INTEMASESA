...
public class JubiladosParcialesResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(JubiladosParcialesResultImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/jubiladosparciales/results.jsp";
