...
public class PlusesFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(PlusesFormImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/pluses/form.jsp";
