...
public class GestionComunicacionesFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(GestionComunicacionesFormImpl.class);
