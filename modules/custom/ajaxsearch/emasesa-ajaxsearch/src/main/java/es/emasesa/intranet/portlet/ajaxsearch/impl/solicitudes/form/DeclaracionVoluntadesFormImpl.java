...
public class DeclaracionVoluntadesFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(DeclaracionVoluntadesFormImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/declaracionvoluntades/form.jsp";
