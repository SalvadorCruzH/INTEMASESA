...
public class ConsultasFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(ConsultasFormImpl.class);
    ...
    private static final String VIEW = "/views/consultas/form.jsp";
