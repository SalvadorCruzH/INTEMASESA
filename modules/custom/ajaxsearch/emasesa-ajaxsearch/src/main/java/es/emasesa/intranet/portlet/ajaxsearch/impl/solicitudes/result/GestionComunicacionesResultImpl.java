...
public class GestionComunicacionesResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(GestionComunicacionesResultImpl.class);
