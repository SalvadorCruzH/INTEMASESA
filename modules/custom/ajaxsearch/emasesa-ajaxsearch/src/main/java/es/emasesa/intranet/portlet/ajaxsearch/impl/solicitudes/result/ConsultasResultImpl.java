...
public class ConsultasResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(ConsultasResultImpl.class);
    ...
    private static final String VIEW = "/views/consultas/results.jsp";
