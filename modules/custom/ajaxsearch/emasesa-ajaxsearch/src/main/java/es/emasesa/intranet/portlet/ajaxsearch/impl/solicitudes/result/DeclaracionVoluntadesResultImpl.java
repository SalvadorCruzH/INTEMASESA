...
public class DeclaracionVoluntadesResultImpl implements AjaxSearchResult {

    private final static Log LOG = LoggerUtil.getLog(DeclaracionVoluntadesResultImpl.class);
    ...
    private static final String VIEW = "/views/solicitudes/declaracionvoluntades/results.jsp";
