...
<div class="m-searchAjax m-searchAjax--form ema-ajaxsearch-form">
    ...
    <div class="ema-ajaxsearch-form__filters" aria-hidden="false">
        ...
        <div class="ema-ajaxsearch-filtros__text tipo-1">
         ...
         <div class="ema-ajaxsearch-filtros__dates tipo-2" style="display:none;">
            <div class="ema-ajaxsearch-filtros__dateFrom">
                <label><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.news.unique-date"></liferay-ui:message></label>
                <input name="<portlet:namespace />fechaUnica"
                        type="date"
                        value='<%=HtmlUtil.escape(ajaxSearchDisplayContext.getStringRP("fechaUnica")) %>'
                        data-as-id="fechaUnica"
                        class="m-searchAjax__input date"
                        id="fechaUnica"
                />
            </div>
