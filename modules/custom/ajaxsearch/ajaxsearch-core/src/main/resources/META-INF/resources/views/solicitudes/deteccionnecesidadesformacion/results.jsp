        ...
        <div class="m-results-wrapper ema-documentos-ajax ema-ajaxsearch">
            <div class="ema-table__wrapper">
                <table class="ema-table__ajaxsearch">
                    <thead>
                     <tr>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.news.training-plan" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.objects.result.application-date" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.news.formulated" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.news.applicant" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.objects.result.denomination" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.news.status" /></th>
                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.objects.result.obligatory" /></th>
<%--                      <th><liferay-ui:message key="es.emasesa.intranet.ajaxsearch.objects.result.modality" /></th>--%>
                      <th></th>
                     </tr>
                    </thead>
                    <tbody id="as-wrapper">
