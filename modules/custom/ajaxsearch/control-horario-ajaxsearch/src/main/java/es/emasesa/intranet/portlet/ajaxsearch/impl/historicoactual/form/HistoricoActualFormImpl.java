package es.emasesa.intranet.portlet.ajaxsearch.impl.historicoactual.form;
...
public class HistoricoActualFormImpl implements AjaxSearchForm {

    private static final Properties DFLT_PROPERTIES = new Properties();
    private final static Log LOG = LoggerUtil.getLog(HistoricoActualFormImpl.class);
    ...
    private static final String VIEW = "/views/historicoactual/form.jsp";
