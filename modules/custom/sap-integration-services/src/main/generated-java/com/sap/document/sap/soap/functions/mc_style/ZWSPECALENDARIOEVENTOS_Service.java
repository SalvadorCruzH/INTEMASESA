 ...
 * 
 */
@WebServiceClient(name = "Z_WS_PE_CALENDARIO_EVENTOS", targetNamespace = "urn:sap-com:document:sap:soap:functions:mc-style", wsdlLocation = "META-INF/wsdl/z_ws_pe_calendario_eventos.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("META-INF/wsdl/z_ws_pe_calendario_eventos.wsdl");
