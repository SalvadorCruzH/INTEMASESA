...
public class AyudaEscolarService {
    ...
    public Bapireturn1 solicitarAyudaEscolar(String pernr) throws DistanciaCentrosException, SapCommunicationException {

        try {
            Bapireturn1 serviceResult = port.zPeAyudaEscolar(pernr, null ,null ,null, null);
            return serviceResult;
        } catch (ServerSOAPFaultException e) {
            throw new DistanciaCentrosException("Error llamando al WS para el origen "+ pernr, e);
