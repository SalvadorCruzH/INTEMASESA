...
@Component(
        ...
        service = EmasesaUserNotificationEventSearch.class
)
public class EmasesaUserNotificationEventSearch {
    ...
    private static final Log LOG = LogFactoryUtil.getLog(EmasesaUserNotificationEventSearch.class);
}
