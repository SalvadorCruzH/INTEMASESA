package es.emasesa.intranet.portlet.configuraciones.constants;
...
public class EmasesaConfiguracionesWebPortletKeys {
	...
	public static final String MSG_DELETE_OK = "deleteOK";
	public static final String MSG_DELETE_KO = "deleteKO";
