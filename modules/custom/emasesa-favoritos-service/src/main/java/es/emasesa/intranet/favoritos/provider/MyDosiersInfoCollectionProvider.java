...
public class MyDosiersInfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            includeQuery.add( new MatchQuery("objectEntryContent", "\"CE-NOTICIA-DOSIER\""), BooleanClauseOccur.MUST.getName());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-dosiers", "Mis dosieres favoritos");
    }
    ...
    private static final Log LOG = LoggerUtil.getLog(MyDosiersInfoCollectionProvider.class);
