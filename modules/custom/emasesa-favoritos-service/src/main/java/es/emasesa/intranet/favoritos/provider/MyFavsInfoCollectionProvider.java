...
public class MyFavsInfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-favorites");
    }
    ...
    private static final Log LOG = LoggerUtil.getLog(MyFavsInfoCollectionProvider.class);
