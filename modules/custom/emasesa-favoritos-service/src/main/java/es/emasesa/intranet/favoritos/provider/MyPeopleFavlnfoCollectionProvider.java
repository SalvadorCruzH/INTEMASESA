...
public class MyPeopleFavlnfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            includeQuery.add( new MatchQuery("objectEntryContent", "\""+ _portal.getClassNameId(User.class)+"\""), BooleanClauseOccur.MUST.getName());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-people-favorite", "Mis personas favoritas");
    }
    ...
    protected void activate(Map<String, Object> properties) {
        ...
        LOG.debug("Activate MyPeopleFavInfoCollectionProvider");
    ...
    private static final Log LOG = LoggerUtil.getLog(MyPeopleFavlnfoCollectionProvider.class);
