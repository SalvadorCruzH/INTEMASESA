...
public class MyGroupslnfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            includeQuery.add( new MatchQuery("objectEntryContent", "\""+ _portal.getClassNameId(Group.class)+"\""), BooleanClauseOccur.MUST.getName());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-groups-favorite", "Mis grupos favoritos");
    }
    ...
    protected void activate(Map<String, Object> properties) {
        ...
        LOG.debug("Activate MyGroupsInfoCollectionProvider");
    ...
    private static final Log LOG = LoggerUtil.getLog(MyGroupslnfoCollectionProvider.class);
