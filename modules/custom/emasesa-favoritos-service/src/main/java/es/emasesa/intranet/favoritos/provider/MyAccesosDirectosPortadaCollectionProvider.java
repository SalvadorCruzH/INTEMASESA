...
public class MyAccesosDirectosPortadaCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            MatchQuery objectDefinitionQuery = new MatchQuery("objectDefinitionId", _configuration.objectPortadaDefinitionId());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-favs-apps", "Mis accesos directos portada");
    }
    ...
    private static final Log LOG = LoggerUtil.getLog(MyAccesosDirectosPortadaCollectionProvider.class);
