...
public class MySemanalnfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            includeQuery.add( new MatchQuery("objectEntryContent", "\"CE-SEMANAL\""), BooleanClauseOccur.MUST.getName());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-favs-semanal", "Mis semanales favoritos");
    }
    ...
    private static final Log LOG = LoggerUtil.getLog(MySemanalnfoCollectionProvider.class);
