...
public class MyNewsInfoCollectionProvider extends BaseMyFavsInfoCollectionProvider implements InfoCollectionProvider<AssetEntry> {
    ...
    public InfoPage<AssetEntry> getCollectionInfoPage(CollectionQuery collectionQuery) {
        ...
        try {
            ...
            includeQuery.add( new MatchQuery("objectEntryContent", "\"CE-NOTA-PRENSA\""), BooleanClauseOccur.MUST.getName());
    ...
    public String getLabel(Locale locale) {
        return _language.get(locale, "my-favs-news", "Mis noticias favoritas");
    }
    ...
    private static final Log LOG = LoggerUtil.getLog(MyNewsInfoCollectionProvider.class);
