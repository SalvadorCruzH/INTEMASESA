...
@Component(
        immediate = true,
        property = "indexer.class.name=com.liferay.object.model.ObjectDefinition#205148", // TODO: alguna manera de dinamizarlo.
        service = IndexerPostProcessor.class
)
public class CustomObjectTestFavoritosEnlacesIndexerPostProcessor implements IndexerPostProcessor{

    private static final Log _log = LoggerUtil.getLog(CustomObjectTestFavoritosEnlacesIndexerPostProcessor.class);
