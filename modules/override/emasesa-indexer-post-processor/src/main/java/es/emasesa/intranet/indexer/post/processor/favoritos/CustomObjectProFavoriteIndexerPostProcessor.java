...
public class CustomObjectProFavoriteIndexerPostProcessor implements IndexerPostProcessor{

    private static final Log _log = LoggerUtil.getLog(CustomObjectProFavoriteIndexerPostProcessor.class);
